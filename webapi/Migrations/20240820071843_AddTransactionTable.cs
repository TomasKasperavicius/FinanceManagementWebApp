        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_ReceiverBankID",
                        column: x => x.ReceiverBankID,
                        principalTable: "Accounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_SenderBankID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ReceiverBankID",
                table: "Transactions",
                column: "ReceiverBankID");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SenderBankID",
                table: "Transactions",
                column: "SenderBankID");
        }
